...
#	fchat16.png
	...
	cp ./ico/fchat16.png ${DESTDIR}/usr/share/pixmaps/pidgin/protocols/16/fchat.png
...
#	fchat22.png
	...
	cp ./ico/fchat22.png ${DESTDIR}/usr/share/pixmaps/pidgin/protocols/22/fchat.png
...
#	fchat48.png
	...
	cp ./ico/fchat48.png ${DESTDIR}/usr/share/pixmaps/pidgin/protocols/48/fchat.png
